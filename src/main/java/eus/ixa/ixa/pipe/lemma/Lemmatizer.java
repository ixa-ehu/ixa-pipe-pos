...
/**
 * The interface for lemmatizers which provide lemma classes for a sequence of tokens.
 */
public interface Lemmatizer {

  /**
   * Generates lemma tags for the given sequence returning the result in an array.
   *
   * @param toks an array of the tokens or words of the sequence.
   * @param tags an array of the pos tags of the sequence.
   *
   * @return an array of lemma tags for each token in the sequence.
   */
  public String[] lemmatize(String[] toks, String tags[]);

  /**
   * Returns the top k lemma classes for the specified sentence with the specified pos-tags
   * @param sentence The tokens of the sentence.
   * @param tags The pos-tags for the specified sentence.
   *
   * @return the top k lemma classes for the specified sentence.
   */
